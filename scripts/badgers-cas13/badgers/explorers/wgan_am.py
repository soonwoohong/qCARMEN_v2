...
from ..utils.prepare_sequences import mismatch_nuc_specific as mismatch_nuc_specific
...
class WGANExplorer(flexs.Explorer):
    ...
    def propose_sequences(self, measured_sequences: pd.DataFrame) -> Tuple[np.ndarray, np.ndarray]:
        ...
        if(self.optimizer == 'adam'):
            ...
            opt = tf.keras.optimizers.legacy.Adam(learning_rate=self.adam_lr)
