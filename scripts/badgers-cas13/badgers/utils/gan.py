...
def train_and_validate(gen_model, disc_model, x_train,
    ...
    gen_optimizer = tf.keras.optimizers.legacy.Adam(learning_rate=0.0001)
...
def load_models(load_path, params = gen_saved_params):
    ...
    x_train = np.load(load_path + '/saved_loadmodel_traindata.npy', allow_pickle=True)
    x_validate = np.load(load_path + '/saved_loadmodel_xvalidationdata.npy', allow_pickle=True)
